...
"""
print('Loading data......')
sub_train_images, sub_train_labels, sub_test_images, sub_test_labels = init_subset('0885') # input your ASUID last 4 digits here to generate the subset samples of MNIST for training and testing
...
for e in range(epoch):
    ...
    test_loss_list = np.append(test_loss_list, test_loss)net = Net()
epoch = 10           ### Default number of epochs
batch_size = 100      ### Default batch size
num_batch = sub_train_images.shape[0]/batch_size
...
plt.plot(epoch_no, train_accuracy_list)
...
plt.plot(epoch_no, test_accuracy_list)
plt.xlabel("Epoch Number")
